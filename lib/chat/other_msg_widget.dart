      ...
      child: ConstrainedBox(
        ...
        child: Card(
         ...
         crossAxisAlignment: CrossAxisAlignment.start,
            ...
            Text(sender,style:  const TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: Colors.black),),
            SizedBox(height: 3,),
            Text(msg,style: const TextStyle(fontSize: 13,fontWeight: FontWeight.bold,color: Colors.pinkAccent),),]
          ),),
        ),
      ),
    );
