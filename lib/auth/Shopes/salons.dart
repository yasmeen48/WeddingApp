                ...
                return InkWell(
                  onTap: () {
                    setState(() {
                      selectedindex = index;
                      if (selectedindex == 0) {
                        Navigator.of(context).pushNamed("sh0salonsinfo");
                      }
                      if (selectedindex == 1) {
                        Navigator.of(context).pushNamed("sh1salonsinfo");
                      }
                      if (selectedindex == 2) {
                        Navigator.of(context).pushNamed("sh2salonsinfo");
                      }
                      if (selectedindex == 3) {
                        Navigator.of(context).pushNamed("sh3salonsinfo");
                      }

                      if (selectedindex == 4) {
                        Navigator.of(context).pushNamed("sh4salonsinfo");
                      }
                      if (selectedindex == 5) {
                        Navigator.of(context).pushNamed("sh5salonsinfo");
                      }
                    });
                  },
                  child: Column(
