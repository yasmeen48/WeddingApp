                ...
                return InkWell(
                  onTap: () {
                    setState(() {
                      selectedindex = index;
                      if (selectedindex == 0) {
                        Navigator.of(context).pushNamed("sh0flowersinfo");
                      }
                      if (selectedindex == 1) {
                        Navigator.of(context).pushNamed("sh1flowersinfo");
                      }
                      if (selectedindex == 2) {
                        Navigator.of(context).pushNamed("sh2flowersinfo");
                      }
                      if (selectedindex == 3) {
                        Navigator.of(context).pushNamed("sh3flowersinfo");
                      }

                      if (selectedindex == 4) {
                        Navigator.of(context).pushNamed("sh4flowersinfo");
                      }
                      if (selectedindex == 5) {
                        Navigator.of(context).pushNamed("sh5flowersinfo");
                      }
                    });
                  },
                  child: Column(
