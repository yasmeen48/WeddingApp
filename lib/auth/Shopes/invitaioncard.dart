                ...
                return InkWell(
                  onTap: () {
                    setState(() {
                      selectedindex = index;
                      if (selectedindex == 0) {
                        Navigator.of(context).pushNamed("sh0invitaioncardinfo");
                      }
                      if (selectedindex == 1) {
                        Navigator.of(context).pushNamed("sh1invitaioncardinfo");
                      }
                      if (selectedindex == 2) {
                        Navigator.of(context).pushNamed("sh2invitaioncardinfo");
                      }
                      if (selectedindex == 3) {
                        Navigator.of(context).pushNamed("sh3invitaioncardinfo");
                      }

                      if (selectedindex == 4) {
                        Navigator.of(context).pushNamed("sh4invitaioncardinfo");
                      }
                      if (selectedindex == 5) {
                        Navigator.of(context).pushNamed("sh5invitaioncardinfo");
                      }
                    });
                  },
                  child: Column(
