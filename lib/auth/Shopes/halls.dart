                ...
                return InkWell(
                  onTap: () {
                    setState(() {
                      selectedindex = index;
                      if (selectedindex == 0) {
                        Navigator.of(context).pushNamed("sh0hallsinfo");
                      }
                      if (selectedindex == 1) {
                        Navigator.of(context).pushNamed("sh1hallsinfo");
                      }
                      if (selectedindex == 2) {
                        Navigator.of(context).pushNamed("sh2hallsinfo");
                      }
                      if (selectedindex == 3) {
                        Navigator.of(context).pushNamed("sh3hallsinfo");
                      }

                      if (selectedindex == 4) {
                        Navigator.of(context).pushNamed("sh4hallsinfo");
                      }
                      if (selectedindex == 5) {
                        Navigator.of(context).pushNamed("sh5hallsinfo");
                      }
                    });
                  },
                  child: Column(
